...
Revision ID: d06b85b8e3b5
Revises: 
Create Date: 2024-11-24 11:48:05.493024
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('NEW', 'PENDING', 'DONE', 'ERROR', name='requeststatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('request_authors',
    sa.Column('request_id', sa.Integer(), nullable=False),
    sa.Column('author_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['author_id'], ['authors.id'], ),
    ...
    op.create_table('request_genres',
    sa.Column('request_id', sa.Integer(), nullable=False),
    sa.Column('genre_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['genre_id'], ['genres.id'], ),
